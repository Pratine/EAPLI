...
public class Strings {
    ...
    public static boolean isOnlyDigits(String mecanographicNumber){
       return mecanographicNumber.matches("[0-9]+");
    }
    
    public static boolean isOnlyLetters(String mecanographicNumber){
        return mecanographicNumber.matches("[a-z]+");
    }
    
    public static boolean hasLettersAndNumbers(String mecanigraphicNumber){
        return mecanigraphicNumber.matches("([0-9]+[a-z]+)|([a-z]+[0-9]+)");
    }
}
