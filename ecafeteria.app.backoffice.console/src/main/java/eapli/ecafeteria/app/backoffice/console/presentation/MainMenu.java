...
import eapli.ecafeteria.app.backoffice.console.presentation.kitchen.CopyMenuAction;
import eapli.ecafeteria.app.backoffice.console.presentation.kitchen.CreateMenuPlanAction;
import eapli.ecafeteria.app.backoffice.console.presentation.kitchen.EditMenuPlanAction;
import eapli.ecafeteria.app.backoffice.console.presentation.kitchen.ListBatchsUsedAction;
import eapli.ecafeteria.app.backoffice.console.presentation.kitchen.ListMaterialAction;
import eapli.ecafeteria.app.backoffice.console.presentation.kitchen.RegisterBatchAction;
import eapli.ecafeteria.app.backoffice.console.presentation.kitchen.RegisterMaterialAction;
import eapli.ecafeteria.app.backoffice.console.presentation.kitchen.RegisterMealsMadeAction;
import eapli.ecafeteria.app.backoffice.console.presentation.kitchen.ShowBookingsByDayAction;
...
public class MainMenu extends AbstractUI {
    ...
    //MENU
    private static final int CLOSE_MENU_PLAN = 3;
    private static final int CREATE_EDIT_MENU = 4;

    //BATCH
    private static final int SEARCH_MEAL_BY_BATCH = 5;
    private static final int BATCH_USED_LIST = 7;
    private static final int REGISTER_BATCH = 6;
...
// REPORTING
    ...
    private static final int MEALS_OPTION = 3;
    private static final int SETTINGS_OPTION = 4;
    private static final int DISH_TYPES_OPTION = 5;
    private static final int TRACEABILITY_OPTION = 6;
    private static final int REPORTING_DISHES_OPTION = 7;
    private static final int BOOKING_OPTION = 8;
    private static final int MENU_PLAN_OPTION = 9;
    private static final int MENU_OPTION = 10;

    //BOOKINGS
    private static final int SHOW_BOOKINGS_BY_DAY = 1;

    //MEALS
    private static final int REGISTER_MEALS_MADE_OPTION = 1;
    
    //Menus
    private static final int CREATE_MENU_PLAN_OPTION = 1;
    private static final int EDIT_MENU_PLAN_OPTION = 2;
    ...
    private Menu buildMainMenu() {
        ...
        if (AuthorizationService.session().authenticatedUser()
            ...
            mainMenu.add(new SubMenu(MEALS_OPTION, mealsMenu,
                    new ShowVerticalSubMenuAction(mealsMenu)));
            ...
            mainMenu.add(new SubMenu(BOOKING_OPTION, bookingsMenu,
        ...
        final Menu editMenuMenu = buildMenuPlanMenu();
            mainMenu.add(new SubMenu(MENU_PLAN_OPTION,editMenuMenu,
                    new ShowVerticalSubMenuAction(editMenuMenu)));
            
        final Menu chooseMenuMenu = buildMenuMenu();
            mainMenu.add(new SubMenu(MENU_OPTION,chooseMenuMenu,
                    new ShowVerticalSubMenuAction(chooseMenuMenu)));
    ...
    private Menu buildKitchenMenu() {
        ...
        menu.add(
                new MenuItem(CLOSE_MENU_PLAN, "Close Menu Plan", new CloseMenuPlanAction()));
        menu.add(
                new MenuItem(CREATE_EDIT_MENU, "Create/Edit Menu", new CreateMenuAction()));
        menu.add(
                new MenuItem(SEARCH_MEAL_BY_BATCH, "Search meals by batch", new CreateBatchMenuAction()));
        menu.add(
                new MenuItem(BATCH_USED_LIST, "List used batch", new ListBatchsUsedAction()));
        menu.add(
                new MenuItem(REGISTER_BATCH, "Register batch into meal", new RegisterBatchAction()));
    ...
    private Menu buildBookingsMenu() {
        ...
        menu.add(new MenuItem(SHOW_BOOKINGS_BY_DAY, "Show Bookings by Day", new ShowBookingsByDayAction()));
    ...
    private Menu buildMealsMenu() {
        ...
        menu.add(new MenuItem(REGISTER_MEALS_MADE_OPTION, "Register Meals Actually Made", new RegisterMealsMadeAction()));
        ...
        private Menu buildMenuPlanMenu(){
        final Menu menu = new Menu("MenuPlan >");
        
        menu.add(new MenuItem(CREATE_MENU_PLAN_OPTION, "Create Menu Plan", new CreateMenuPlanAction()));
        menu.add(new MenuItem(EDIT_MENU_PLAN_OPTION, "Edit Menu Plan", new EditMenuPlanAction()));
        menu.add(new MenuItem(EXIT_OPTION, "Return ", new ReturnAction()));
